...
def patch_prompt(prompt_id: str, prompt_data: PromptUpdate):
    """Partially update a prompt - only provided fields are modified.
    
    Unlike PUT which requires all fields, PATCH only updates fields that are explicitly provided.
